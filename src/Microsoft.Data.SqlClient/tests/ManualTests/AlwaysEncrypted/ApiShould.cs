...
//                        transaction: null
//                        //ConnStringColumnEncryptionSetting: SqlCommandColumnEncryptionSetting.Enabled
//                        ))
//                    {
...
//                    using (SqlCommand sqlCmd = new SqlCommand(inputProcedureName, sqlConnection, null))
//                    {
...
//                    using (SqlCommand sqlCmd = new SqlCommand(outputProcedureName, sqlConnection, null))
//                    {
//                        sqlCmd.CommandType = CommandType.StoredProcedure;
